...
<div class="w-full max-w-md p-8 rounded-xl shadow-lg bg-white/80 backdrop-blur-md border border-white/20 flex flex-col gap-6 relative z-10" >
            ...
            <ul class="flex justify-around" >
                <li>
                    <RouterLink :to="{ name: 'home' }">
                        <HomeIcon class="w-4 text-blue-700"  />
                        <span>Inicio</span>
                    </RouterLink>
                </li>
                <li>
                    <RouterLink :to="{ name: 'home' }">
                        <HealthIcon class="w-4 text-blue-700" />
                        <span>Rutina</span>
                    </RouterLink>
                </li>
                <li>
